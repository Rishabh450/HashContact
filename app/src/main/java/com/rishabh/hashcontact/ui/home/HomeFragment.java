package com.rishabh.hashcontact.ui.home;
...
import com.rishabh.hashcontact.RecyclerViewFiled;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
       ...
       // DatabaseReference reference =FirebaseDatabase.getInstance().getReference().child(id).child("Personal").child("Photo");
        ...
        show.getBackground().setAlpha(90);
        showProfile.getBackground().setAlpha(90);
...
flag1=!flag1;
        ...
        upload.getBackground().setAlpha(97);
