...
public class RecyclerViewChatListt extends RecyclerView.Adapter<RecyclerViewChatListt.ChatListViewHolder>{
    @NonNull
    ArrayList<Map<String,String>> contacts=new ArrayList<Map<String, String>>();
    Context context;int lastPosition;
    public RecyclerViewChatListt(ArrayList<Map<String,String>> contacts, Context context)
    {
    ...
    public ChatListViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.singlechat,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull final ChatListViewHolder chatListViewHolder, final int i) {
        ...
        chatListViewHolder.item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //data[0].put("key",contacts.get(i).get("key"));
                intent.putExtra("id",contacts.get(i).get("key"));
    ...
    public static class ChatListViewHolder extends RecyclerView.ViewHolder {
        ...
        public ChatListViewHolder(@NonNull View itemView) {
            super(itemView);
            item=itemView.findViewById(R.id.single_contact_ite);
            cover=itemView.findViewById(R.id.sin);
            title=itemView.findViewById(R.id.singlecontactbooknam);
        }
    }
